...
- ✅ **Headline Numbers Verified**: 21.61 billion Nm³ CH₄/year (59.19 million m³/day, 215,410.78 GWh/yr) Real Mobilisable Bioenergy Potential.
...
| **Theoretical Potential** | 54.01 bi Nm³ CH₄/yr | 54.0147 bi Nm³ CH₄/yr | 54,014,739,193 m³/yr | ✅ EXACT |
| **Real Mobilisable Potential** | **21.61 bi Nm³/yr (59.19M m³/day)** | **21.6059 bi Nm³/yr (59.19M m³/day)** | **215,410.78 GWh/yr** | ✅ EXACT |
| **Technical Ideal Potential** | 27.01 bi Nm³ CH₄/yr | 27.0074 bi Nm³ CH₄/yr | 27,007,369,596 m³/yr | ✅ EXACT |
...
| **Spatial Gini Inequality** | 0.6932 | 0.6932 | Recomputed live across 853 units | ✅ EXACT |

---

## 2. Feedstock Shares (Real Mobilisable Potential) — ✅ EXACT

Distribution of the **215,410.78 GWh/yr (21.61 billion Nm³ CH₄/yr)** real mobilisable potential across sectors and streams:

| Stream Key | Sector | Gross Residue Basis | Real Energy (GWh/yr) | Real Gas (Million m³/yr) | State Share (%) |
|---|---|---|---|---|---|
| Sugarcane (Bagasse/Straw/Vinasse) | Agricultural | PAM 2023 Harvest | 41,221.37 | 4,134.54 | 19.14% |
| Bovine Cattle Manure | Livestock | PPM 2023 Herd | 13,487.52 | 1,352.81 | 6.26% |
| Swine Slurry | Livestock | PPM 2023 Herd | 74,062.89 | 7,428.57 | 34.38% |
| Poultry Litter | Livestock | PPM 2023 Herd | 10,899.31 | 1,093.21 | 5.06% |
| Corn Stover | Agricultural | PAM 2023 Harvest | 19,108.53 | 1,916.60 | 8.87% |
| Soybean Straw | Agricultural | PAM 2023 Harvest | 23,614.59 | 2,368.57 | 10.96% |
| Coffee Husk | Agricultural | PAM 2023 Harvest | 4,844.56 | 485.91 | 2.25% |
| Urban MSW Organic (FORSU) | Urban & Sanitation | SNIS / IBGE 2022 | 7,473.77 | 749.63 | 3.47% |
| Agroforestry Residues | Forestry | PEVS 2023 Silviculture | 20,373.22 | 2,043.45 | 9.46% |
| Citrus Bagasse | Agricultural | PAM 2023 Harvest | 106.73 | 10.71 | 0.05% |
| Urban Pruning (RPO) | Urban & Sanitation | Population Model | 149.31 | 14.98 | 0.07% |
| Aquaculture Residues | Livestock | PPM 2023 Production | 68.97 | 6.92 | 0.03% |
| **Total Real Potential** | **Statewide** | **All 13 Primary Streams** | **215,410.78** | **21,605.90** | **100.00%** |
...
- **State Gini Coefficient**: **0.6932** across all 853 municipalities.
- **Top 5 Intermediate Regions**: Hold **71.14%** of the total state mobilisable bioenergy potential:
  1. Patos de Minas: 45,398.59 GWh/yr (21.08%)
  2. Uberaba: 38,948.64 GWh/yr (18.08%)
  3. Uberlândia: 28,030.06 GWh/yr (13.01%)
  4. Divinópolis: 25,369.89 GWh/yr (11.78%)
  5. Montes Claros: 15,487.47 GWh/yr (7.19%)
- **Municipal Extremes**:
  - Maximum Potential: Uberlândia (7,580.11 GWh/yr) & Belo Horizonte (6,029.50 GWh/yr).
...
- **K-Means Typology Optimization**: Evaluated across $K=2..8$; optimal silhouette achieved at **$K=5$** ($S \approx 0.48$).
  - Cluster 0 (*Swine-Dominated*): 466 municipalities.
  - Cluster 1 (*Swine-Dominated*): 221 municipalities.
...
- **Spatial Autocorrelation (LISA Moran's I)**:
  - **Global Moran's I**: **0.6659**, confirming strong spatial clustering of bioenergy resources in MG.
  - **High-High (HH) Hotspots**: 85 municipalities holding 38.4% of statewide bioenergy potential.
  - **Low-Low (LL) Coldspots**: 74 municipalities concentrated in lower residue density zones.
...
|---|---|---|---|
| `analysis/data/01_master_residue_streams_MG_2023.csv` | 7,866 rows | Master 29-column long-format stream potentials | `32bf52918dca60974d85e8e9f0f61f53e362ba5525a1d2c0a3de4fd7630b8ba6` |
| `analysis/data/02_municipality_summary_MG_2023.csv` | 853 rows | Municipality summary 28-column dataset | `7191ceb32acbc020894ab8aa019c8d3bad904c706115dd5e91811b55d4f1c044` |
...
| `analysis/outputs/MG_biochemical_matching_all_853.csv` | 853 rows | Municipal C:N, TS%, Shannon H' profiles | `0374b5009f43bfea0663534fc91c8c409bd5ba18c5774ea78d1a5c7ee388d978` |
| `analysis/outputs/MG_top_priority_pairs_biochemical.csv` | 214 rows | Top screened spatial co-digestion pairs | `09e381318ca8545505e4f87db20a0571274c0ce7c180042873849c1994ec4f38` |
| `analysis/outputs/MG_spatial_clusters_853.csv` | 853 rows | K-means typology & DBSCAN cluster labels | `8690fa6da6ebbbbfb8b5132fc9a99f0544d6576badddd84b96ce780e69b22f39` |
| `analysis/outputs/MG_lisa_spatial_autocorrelation.csv` | 853 rows | Local Moran's I & LISA quadrant classifications | `c43f7c40375b0906b27824e2f850b1815f8e4499523357711302bbccaf181b56` |
| `analysis/outputs/MG_empirical_realization_summary.csv` | 853 rows | Municipal empirical realization benchmarks | `df35e366576b6b25b9107508dd0af55c13029ec88b0323bb3736059c1653db91` |
| `analysis/outputs/MG_empirical_realization_rgint_summary.csv` | 13 rows | RGint regional realization summaries | `a13255e072730be1a83b474474589e356f1e316055a92eed60136cf57986c419` |
...
| `analysis/paper_verification/PILAR2b_MG_paper_verification.xlsx` | 7 sheets | Consolidated multi-tab workbook with formulas | `4243f33dcbbb119728c24ddc82873bf9661201f5717c82286202ef45a9cd7867` |
