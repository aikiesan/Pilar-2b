            ...
            <div className="flex-shrink-0">
              ...
              >
                <Image
                  ...
                  priority
                />
                <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${isPublic
              ...
              {!AUTH_DISABLED && (isAuthenticated && user ? (
                <div className={`border-t ${isPublic ? 'border-gray-200 dark:border-slate-700' : 'border-white/20'} px-4 py-4`}>
                  <div className="flex items-center gap-3 mb-3">
                    <User className={`h-8 w-8 p-1 rounded-full ${isPublic ? 'text-gray-700 dark:text-slate-300 bg-gray-100 dark:bg-slate-700' : 'text-white bg-white/20'
                      }`} />
                    <div>
