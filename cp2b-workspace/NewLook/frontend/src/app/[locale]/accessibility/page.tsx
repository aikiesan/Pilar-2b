  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          'A “skip to content” link on every page; labels associated with form fields; announced error messages; adequate color contrast on primary elements; screen-reader support.',
        ],
      },
      {
