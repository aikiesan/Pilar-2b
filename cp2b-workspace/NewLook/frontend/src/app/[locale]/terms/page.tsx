  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        p: [
          'The code is distributed under the GPL-3.0 license. The platform is registered with INPI (BR512026003115-0). Source data belongs to its respective providers (IBGE, MapBiomas, EMBRAPA, among others) and must be cited under their licences.',
        ],
      },
      {
