...
def seed_data():
    ...
    for feature in features:
        ...
        """, (
            ibge_code, name, p.get('area_km2'), p.get('population'),
            p.get('total_biogas_m3_year'), p.get('agricultural_biogas_m3_year'),
            p.get('livestock_biogas_m3_year'), p.get('urban_biogas_m3_year'),
            p.get('immediate_region'), p.get('intermediate_region'),
            p.get('immediate_region_code'), p.get('intermediate_region_code')
        ))
