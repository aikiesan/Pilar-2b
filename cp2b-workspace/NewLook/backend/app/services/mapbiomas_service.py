...
MAPBIOMAS_CLASSES = {
    15: {"name": "Pastagem", "color": "#FFD966", "category": "agricultural"},
    9: {"name": "Silvicultura", "color": "#6D4C41", "category": "forestry"},
    39: {"name": "Soja", "color": "#E1BEE7", "category": "agricultural"},
    20: {"name": "Cana-de-açúcar", "color": "#C5E1A5", "category": "agricultural"},
    40: {"name": "Arroz", "color": "#FFCDD2", "category": "agricultural"},
    62: {"name": "Algodão", "color": "#F8BBD9", "category": "agricultural"},
    41: {"name": "Outras Temporárias", "color": "#DCEDC8", "category": "agricultural"},
    46: {"name": "Café", "color": "#8D6E63", "category": "agricultural"},
    47: {"name": "Citros", "color": "#FFA726", "category": "agricultural"},
    35: {"name": "Dendê", "color": "#66BB6A", "category": "agricultural"},
    48: {"name": "Outras Perenes", "color": "#A1887F", "category": "agricultural"},
    # Additional classes that might appear
    0: {"name": "Sem dados", "color": "#000000", "category": "nodata"},
    3: {"name": "Formação Florestal", "color": "#1F8D49", "category": "forest"},
    4: {"name": "Formação Savânica", "color": "#7DC975", "category": "forest"},
    11: {"name": "Área Alagada", "color": "#519799", "category": "water"},
    12: {"name": "Formação Campestre", "color": "#D6BC74", "category": "grassland"},
    21: {"name": "Mosaico Agricultura-Pastagem", "color": "#FFEFC3", "category": "agricultural"},
    24: {"name": "Infraestrutura Urbana", "color": "#AF2A2A", "category": "urban"},
    25: {"name": "Outra Área não Vegetada", "color": "#FF99FF", "category": "other"},
    33: {"name": "Rio, Lago e Oceano", "color": "#0000FF", "category": "water"},
}
...
class MapBiomasService:
    ...
    def analyze_buffer(self, lat: float, lng: float, radius_km: float) -> Dict[str, Any]:
        """
            ...
            with rasterio.open(self.raster_path) as src:
                ...
                try:
                    out_image, out_transform = mask(
                        src, [mapping(buffer_for_mask)], crop=True, nodata=0, filled=True
                    )
                ...
                for class_id, count in pixel_counts.items():
                    ...
                    class_info = MAPBIOMAS_CLASSES.get(
                        class_id,
                        {"name": f"Classe {class_id}", "color": "#808080", "category": "unknown"},
                    )
                ...
                agricultural_percent = (
                    (agricultural_pixels / total_pixels * 100) if total_pixels > 0 else 0
                )
