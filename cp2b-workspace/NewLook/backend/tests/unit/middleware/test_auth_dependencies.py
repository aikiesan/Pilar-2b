...
from app.middleware.auth import require_internal, require_clearance, require_admin
from app.models.auth import UserProfile


def _user(role="autenticado", clearance=0):
    return UserProfile(
        id="u", email="u@cp2b.unicamp.br", full_name="U",
        role=role, clearance=clearance, is_active=True,
